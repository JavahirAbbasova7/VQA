...
def train(model, data_loader, optimizer, tokenizer, epoch, warmup_steps, device, scheduler, config):
    ...
    for i, (image, question, answer, weights, n) in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
        ...
        loss_mlm, loss_ita, loss_itm = model(image, question_input, alpha = alpha)  
...
def main(args, config):
    ...
    data_loader = create_loader(datasets,samplers,batch_size=[config['batch_size']], num_workers=[4],is_trains=[True], collate_fns=[vqa_collate_fn])[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', default='./checkpoints/Pretrain_14M.pth') 
